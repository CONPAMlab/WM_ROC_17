...
Tvec = [0 1];
Ntrials = 20000; % Number of simulated trials used to construct the model predictions; unrelated to number of experimental trials
...
%             decision = mean(exp((x-0.5).*J),2)>crit(ict);
